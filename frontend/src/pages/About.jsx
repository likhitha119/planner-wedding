  ...
  return (
    <div className="about-page">
      ...
      <section className="image">
        ...
        <div className="row">
          <img src="/assets/photos/beautiful1.jpeg" alt="Beautiful Wedding Setup" className="image" />
          <p>
      ...
      <section className="testimonials">
        ...
        <blockquote>
          <p>"Let's Celebrate Together made our wedding day absolutely perfect! They took care of everything, and we couldn't have been happier!"</p>
      ...
      <footer>
        <p>&copy; 2023 Let's Celebrate Together. All rights reserved.</p>
      </footer>
    </div>
  )
}
